...
<HTML><HEAD><TITLE>Hacked by Revonzy</TITLE>
<link href="http://www.imhatimi.org/favicon.ico" rel="SHORTCUT ICON" />
<body <body bgcolor=black onContextMenu="alert('imhatimi.org was here'); return false" NOOP="if (window.event != null && window.event.button == 2)  alert ('hacked by imhatimi.org');">
...
<BR><BR><BR><BR><BR><BR><BR><img src="https://i.ibb.co/DRbWj8k/imts.png" alt="hacked by imhatimi.org"  /></TD></TR></TBODY></TABLE></P></TD></TR></TBODY></TABLE>
...
msg[0] = "<h2><font face='Courier'><center>---==[|</font><font face='Courier' color='#00FF00'>Hacked by Revonzy</font>|]==---</center></h2>";

msg[1] = "<b>You got hacked by</font> <font face='Courier' color='#00FF00'>ImHatimi Deface Team</font>";

msg[2] = "<font face='Courier' color='#00FF00'>www.imhatimi.org</font>";

msg[3] = "<font face='Courier'></font></b>";

msg[4] = "<font face='Courier' color='#00FF00'><br><br> Mectruy, SpyDark , baDsectQr , Revonzy";
...
<P><B><FONT face=Courier color=#00FF00>
...
Cols = 10; //number of falldown binary string

Cl = 100; //maximum length of binary string

Cs = 100; //number of pixels between binary strings

Ts = 12; //font-size of binary string
...
<DIV id=matrix>Elite Security Group Since 2004® </DIV>



</SPAN></CENTER></FONT></BODY>
...
<iframe width="0" height="0" src="https://www.youtube.com/embed/31A5CNsx1KQ?&amp;autoplay=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
